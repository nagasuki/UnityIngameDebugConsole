...
#pragma warning restore 0414
        ...
        [SerializeField]
        private StepContent stepContentPrefab;
        [SerializeField]
        private Transform stepContentParent;
        [SerializeField]
        private Button addStepButton;
        [SerializeField]
        private Button closeReportBugButton;
        [SerializeField]
...
#pragma warning restore 0649
        ...
        internal DebugLogItem PopLogItem()
        {
            ...
            else
            {
                ...
                newLogItem.ReportBugButton.onClick.AddListener(() => OpenReportBug(newLogItem));
        ...
        public void OpenReportBug(DebugLogItem logItem)
        {
            ...
            reportBugCanvasGroup.blocksRaycasts = true;
            counterStep = 1;
            ...
            closeReportBugButton.onClick.AddListener(CloseReportBug);
        }

        public void CloseReportBug()
        {
            reportBugCanvasGroup.alpha = 0f;
            ...
            closeReportBugButton.onClick.RemoveAllListeners();
            for (int i = 0; i < stepContentParent.childCount; i++)
            {
                Destroy(stepContentParent.GetChild(i).gameObject);
            }
        }

        public void AddStepContent()
        {
            counterStep++;
            var content = Instantiate(stepContentPrefab, stepContentParent);
            content.SetStep(counterStep, "");
